//
//  TableViewControllerAffiche.swift
//  Reader
//
...
class TableViewControllerAffiche: UITableViewController , XMLParserDelegate {
    var films: [Film] = []
    var eName: String = ""
    var filmName = ""
    var filmDescription = ""
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        let path:String = "http://rss.allocine.fr/ac/cine/alaffiche"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "affiche", for: indexPath)
