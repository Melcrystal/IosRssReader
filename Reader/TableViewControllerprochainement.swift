//
//  TableViewControllerprochainement.swift
//  Reader
//
...
class TableViewControllerprochainement: UITableViewController , XMLParserDelegate {
    var films: [Film] = []
    var eName: String = ""
    var filmName = ""
    var filmDescription = ""
    ...
    var jsString = "document.getElementsByTagName('body')[0].style.fontSize='1px'"
    
    override func viewDidLoad() {
        super.viewDidLoad()
        let path:String = "http://rss.allocine.fr/ac/cine/prochainement"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "prochainement", for: indexPath)
        ...
        if let cellLabel = cell.viewWithTag(1) as? UIWebView {
            ...
            cellLabel.stringByEvaluatingJavaScript(from: jsString)
        }
